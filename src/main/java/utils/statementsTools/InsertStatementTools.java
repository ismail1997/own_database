...
public class InsertStatementTools {
	...
	public static void main( String [] args ) throws Exception {
		String insertOne  = "insert into users values (4,'2',23.45)|(4,'dfdf',23.45);";
		...
		String insertTest = "insert into users               (email,id,price) values      ('ismail@gmail.com',2,23.45)|('hitman@gmail.com',34,56)|('hitman@gmail.com',34,56);";
		String insertTestTwo = "insert into users               (price,email,id) values      (23.45,'sd',3)|(45.34,'google',53);";

		String statement="insert into user(id,email,firstname,lastname,age)  values (234,'lk','lk','lk',34 ) | (214,'lk','lk','lk',34 ) | (214,'lk','lk','lk',34 );";
	...
	public static void validInsertStatementold(String statement) throws Exception {
